 ...
 * Class RestClient
 *
 * RestClient is used to perform the http requests to the MusicBot API
 */
class RestClient
{
    /**
     * Timeout represents the HTTP timeout when HTTP requests to the MusicBot API are performed
     * @var int
     */
    protected $timeout = null;
    /**
     * Token is the MusicBot auth token which will be there temporary stored.
     * @var string
     */
    protected $token = null;
    /**
     * URL is the MusicBot URL with the port and the HTTP protocol
     * @var string
     */
    protected $url = null;
    /**
    ...
    /**
     * request executes a request to the MusicBot API
     *
